...
class MenuViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = Mode.Colors.background
...
extension MenuViewController: GKTurnBasedMatchmakerViewControllerDelegate {
    ...
    // allow the following method to enable back button
    // functionality
    @IBAction func unwindToThisView(seque: UIStoryboardSegue)
    {
